...
### **Table of Contents**
- [DevOps Project Report: Automated CI/CD Pipeline for a 2-Tier Flask Application on AWS](#devops-project-report-automated-cicd-pipeline-for-a-2-tier-flask-application-on-aws)
